...
class BookspiderSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for book in books:
            book_relative_url = book.css(".image_container a::attr(href)").get()
    ...
    def parse_book_page(self, response):
        ...
        book_item["avg_rating"] = response.css("p.star-rating").attrib["class"]
        book_item["book_category"] = response.xpath(
